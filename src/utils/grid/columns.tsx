...
export const FormularyBenefitsConfigurationColumns: (data) => Column<any>[] = (data) => {
  return [
    ...
    },
    {
      ...
      customContent: (props) => <div>test</div>,
      isFilterable: true,
      dataType: "string",
      filters: textFilters,
      hidden: false,
...
export const networkOfferColumns: (data?) => Column<any>[] = (data) => {
  return [
    {
      position: 1,
      sorter: {},
    ...
    },
    {
      ...
      pixelWidth: 50,
      key: "claim",
      displayTitle: "claim dollar amount",
      customContent: (props) => (
        <div className=""><input type="text" className="input-text" /></div>
      ),
      isFilterable: true,
      dataType: "string",
      //filters: textFilters,
...
export const BenefitsGridColumns: (
  data?,
  hiddenColumns?
  ...
  return [
    ...
    },
    {
      ...
      displayTitle: "step",
      customContent: (props) => (
        <div className="formulary-step" title={props.data.step}>
              {props.data.step}
            </div>
      ),
      isFilterable: true,
