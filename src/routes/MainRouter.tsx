...
import AdvanceSearchContainer from "../components/NewFormulary/NewAdvanceSearch/AdvanceSearchContainer";
import FormularyBenifits from "../components/NewFormularyBenefits/FormularyBenefits";
  ...
  render() {
    return (
      <React.Fragment>
        <NavBar />
        <Switch>
          <Route exact path="/" render={(props) => <FormularyBenifits {...props} />} />
          <Route
            exact
          ...
          <Route
            exact
            path="/newadvancesearch"
            render={(props) => <AdvanceSearchContainer {...props} />}
          />
