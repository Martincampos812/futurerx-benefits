...
class FrxGrid extends Component<FrxGridProps<any>, FrxGridState<any>> {
  ...
  dragRowsProps = {
    onDragEnd: (fromIndex, toIndex) => {
      fromIndex--;
      toIndex--;
      if(!this.props.enableRowDrag) return;
      this.props.onRowDrag(fromIndex, toIndex);
    },
    nodeSelector: "tr",
    handleSelector: ".frx-grid-cell--drag-visible",
  };
          ...
          c["render"] = (record: any) => {
            ...
            if (showSettingsMenu) {
              ...
              return (
                <>
                {
                  this.props.enableRowDrag &&
                  <div className="frx-grid-cell--drag-visible" style={{display: 'flex', justifyContent: 'center'}}>
  ...
  getGridData = () => {
    ...
    console.log("Get Grid Call", this.state);
  ...
  */
  ...
  render() {
    ...
    const gridRows = this.getGridData();
    ...
    return (
      <>
        ...
        <div ref={this.gridRef} className="frx-grid">
          ...
          <ReactDragListView {...this.dragRowsProps}>
