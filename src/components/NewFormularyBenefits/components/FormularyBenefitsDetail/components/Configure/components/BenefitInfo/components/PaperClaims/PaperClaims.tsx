...
import "./PaperClaims.scss";
import { Radio ,Input } from 'antd';
export default class PaperClaims extends React.Component<any, any> {
    state = {
        value: 1,
      };
        ...
        return (
            ...
            <div className='DMR-detail'>
                <div className='detail-date'>
                    <h1>how long does the member have to submit the Pharmacy Paper Claims from the date the prescription was filled?  <span>*</span></h1>
