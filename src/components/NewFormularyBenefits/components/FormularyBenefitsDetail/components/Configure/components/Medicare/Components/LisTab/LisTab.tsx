...
class LisTab extends React.Component<any, any> {
  state = {
  ...
  render() {
    return (
      ...
      <div className="formulary-lis-tab-grid">


        <div className="bordered">
          <div className="formulary-grid-panel-header-container">
            <PanelHeader
              title="LIS - PRE CATASTROPHIC"
              tooltip="LIS - PRE CATASTROPHIC"
          ...
          <div className="inner-lis-table">
                <Row className="tb-heading">
                  <Col span={6} className="col-left-border-first">
                    LIS CATEGORY
                  </Col>
                  <Col span={6} className="col-left-border">
                    GENERIC COST SHARE
                  </Col>
                  <Col span={6} className="col-left-border">
                    BRAND COST SHARE
                ...
                <Row className="tb-inner">
                  <Col span={6} className="col-left-border-first">
                    LIS 1
                  </Col>
                  <Col span={6} className="col-left-border">
                  <Input value='$0.00'  className="input-feild" />
                  </Col>
                  <Col span={6} className="col-left-border">
                  <Input value='$0.00'  className="input-feild" />
                ...
                <Row className="tb-inner">
                  ...
                  <Col span={6} className="col-left-border">
                  <Input value='0%'  className="input-feild" />
                  </Col>
                  <Col span={6} className="col-left-border">
                  <Input value='0%'  className="input-feild" />
                  </Col>
                ...
                <Row className="tb-inner">
                  ...
                  <Col span={6} className="col-left-border">
                  <Input value='3.60%'  className="input-feild" />

                  </Col>
                  <Col span={6} className="col-left-border">
                  <Input value='15%'  className="input-feild" />

                  </Col>
                  <Col span={6} className="col-left-border">
                  <Input value='$89.00'  className="input-feild" />
      ...
      <div className="bordered-table">
          ...
          <div className="inner-lis-table">
                ...
                <Row className="tb-heading">
                  <Col span={8} className="col-left-border-first">
                    LIS CATEGORY
                  </Col>
                  <Col span={8} className="col-left-border">
                    GENERIC COST SHARE
                  </Col>
                  <Col span={8} className="col-left-border">
                    BRAND COST SHARE
                ...
                <Row className="tb-inner">
                  ...
                  <Col span={8} className="col-left-border">
                  <Input value='8.95%'  className="input-feild" />
