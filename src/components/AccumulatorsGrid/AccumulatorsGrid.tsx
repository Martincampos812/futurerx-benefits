...
class AccumulatorsGrid extends React.Component<AccumulatorsGridProps, AccumulatorsGridState> {
  state = {
  ...
  handleSearch = (searchObject) => {
    ...
    if (searchObject && searchObject.status) {
      setTimeout(() => {
        const newData = this.state.data.filter((d) => d.status === searchObject.status);
