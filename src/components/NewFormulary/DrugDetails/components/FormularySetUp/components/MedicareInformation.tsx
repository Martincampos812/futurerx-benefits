            ...
            <Grid container>
                ...
                <Grid item xs={6}>
                    <div className="field-group group setup-panel">
                        ...
                        <div className="field-group__post-fix-text_note">NOTE: Formulary ID assigned by CMS fter initial submission in HPMS</div>
                    </div>
                    ...
                    <div className="field-group group setup-panel">
                        ...
                        <div className="radio-group field-group__radio-group">
                            <RadioButton label="Yes" name="optional_creation" />
                            <RadioButton label="No" name="optional_creation" />
                        </div>
                    </div>
                </Grid>
            </Grid>
