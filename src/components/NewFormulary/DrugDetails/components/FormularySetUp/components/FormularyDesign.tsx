      ...
      <div className="formulary-design-container">
        ...
        <Grid item xs={6}>
            ...
            <div className="field-group group setup-panel">
                ...
                />
                <div className="radio-group field-group__radio-group">
                    <RadioButton label="Yes" name="drug_limit" />
                    <RadioButton label="No" name="drug_limit" />
                </div>
            </div>
            <div className="field-group group setup-panel">
                <PanelHeader
                ...
                />
                <div className="radio-group field-group__radio-group">
                    <RadioButton label="Yes" name="drug_pharmacy" />
                    <RadioButton label="No" name="drug_pharmacy" />
                </div>
            </div>
            <div className="field-group group setup-panel">
                <PanelHeader
                ...
                />
                <div className="radio-group field-group__radio-group">
                    <RadioButton label="Yes" name="generic_substitution" />
                    <RadioButton label="No" name="generic_substitution" />
                </div>
            </div>
        </Grid>
        <Grid item xs={6}>
            <div className="field-group group setup-panel">
                <PanelHeader
                    ...
                    tooltip="ARE PART D DRUGS REQUIRED IN PART B STEP THERAPY PROTOCOLS?"
                    required={true}
                />
                <div className="radio-group field-group__radio-group">
                    <RadioButton label="Yes" name="therapy_protocol" />
                    <RadioButton label="No" name="therapy_protocol" />
                </div>
            </div>
            <div className="field-group group setup-panel">
                <PanelHeader
            ...
            <div className="field-group group setup-panel">
                ...
                />
                <div className="radio-group field-group__radio-group">
                    <RadioButton label="Yes" name="otcs" />
                    <RadioButton label="No" name="otcs" />
                </div>
            </div>
        </Grid>
        </Grid>
