              ...
              <ul>
                ...
                <li>
                  <div className="checkbox-wrapper">
                    ...
                    <label htmlFor="N/A" className="checkbox-label">
                      {" "}
                      Additional Demonstration Drugs (MPP Only)
                    </label>
                    <PanelHeader tooltip="Additional Demonstration Drugs (MPP Only)" />
                  </div>
                </li> :
                this.context.currentSelectedModule === "commercial" ?
                <li>
                  <div className="checkbox-wrapper">
                    ...
                    <PanelHeader tooltip="Patient Residence" />
                  </div>
                </li> : ""
                }
                {this.context.currentSelectedModule === "medicare" ?
              ...
              {this.context.currentSelectedModule === "medicare" ?
                <li>
                  <div className="checkbox-wrapper">
                    ...
                    <PanelHeader tooltip="Over the Counter Coverage" />
                  </div>
                </li> :
                this.context.currentSelectedModule === "commercial" ?
                <li>
                  <div className="checkbox-wrapper">
                    ...
                    <PanelHeader tooltip="Gender Limits" />
                  </div>
                </li> : ""
                }
                {this.context.currentSelectedModule === "medicare" ?
              ...
              <ul className="checkbox-ul">
                ...
                <li>
                  <div className="checkbox-wrapper">
                    ...
                    <PanelHeader tooltip="Prescriber Taxonomy" />
                  </div>
                </li> : ""
                }
                {this.context.currentSelectedModule === "medicare" &&
                <li>
                  <div className="checkbox-wrapper">
                    ...
                    <PanelHeader tooltip="Excluded Drugs" />
                  </div>
                </li> 
                }
                {this.context.currentSelectedModule === "medicare" &&
                ...
                <li>
                  <div className="checkbox-wrapper">
                    <input
                      ...
                      name="N/A"
                      value="N/A"
                      className="checkbox-btn hide-cbx"
                    />
                      ...
                      <div className="add-new-cbx-btn">
                        ...
                        >
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M15.0312 15.0312C18.3507 11.7118 18.3507 6.32989 15.0312 3.01041C11.7117 -0.309078 6.32985 -0.309034 3.01041 3.01041C-0.309032 6.32985 -0.309075 11.7117 3.01041 15.0312C6.32989 18.3507 11.7118 18.3507 15.0312 15.0312ZM14.3241 14.3241C17.2531 11.3952 17.253 6.64641 14.3241 3.71751C11.3952 0.788612 6.64646 0.788569 3.71751 3.71751C0.788571 6.64646 0.788615 11.3952 3.71751 14.3241C6.64641 17.253 11.3952 17.2531 14.3241 14.3241Z"
                            fill="#707683"
                          />
                          <path
                            d="M4.52082 9.02081C4.52082 9.29695 4.74468 9.52081 5.02082 9.52081H8.52082V13.0208C8.52082 13.2969 8.74468 13.5208 9.02082 13.5208C9.29696 13.5208 9.52082 13.2969 9.52082 13.0208V9.52081L13.0208 9.52081C13.297 9.52081 13.5208 9.29695 13.5208 9.02081C13.5208 8.74466 13.297 8.52081 13.0208 8.52081H9.52082L9.52082 5.02081C9.52082 4.74466 9.29696 4.52081 9.02082 4.52081C8.74468 4.52081 8.52082 4.74467 8.52082 5.02081V8.52081H5.02082C4.74468 8.52081 4.52082 8.74466 4.52082 9.02081Z"
                            fill="#707683"
                          />
                        </svg>
                      </div>
