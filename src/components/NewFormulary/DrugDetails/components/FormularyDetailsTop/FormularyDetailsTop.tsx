  ...
  return (
    <div className="drug-detail-top">
      <div className="breadcrum-sec">
        ...
        { FormularyDetailsCont.currentSelectedModule === 'medicare'?
        <div className="version-wrapper">
          <div className="version-dd item">
            Formulary Version 1 
          </div>
          <div className="item">
            <svg
        ...
        :
        <div className="version-grid-wrapper">           
          <div className="item-grid">
            <span onClick={(e) => props.versionGridClick()} >Version 1 </span>
          </div>           
        </div>    
    }
    </div>
