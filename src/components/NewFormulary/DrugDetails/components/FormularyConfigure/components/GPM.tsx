    ...
    return (
      <>
        <div className="bordered">
          ...
          <div className="group-description-management inner-container bg-light-grey display-flex">
            ...
            {this.state.newGroup ? (
              <NewGroup tooltip={this.state.tooltip} formType={1} />
            ) : (
