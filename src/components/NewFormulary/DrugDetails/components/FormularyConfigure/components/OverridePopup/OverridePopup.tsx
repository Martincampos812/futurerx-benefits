        ...
        <div className="override-container">
           ...
           <Grid className="override-wrapper" container spacing={1}>
            ...
            <div className="form set-margin">
                ...
                <RadioButton label="Yes" defaultChecked name="override-radio" onChange={this.handleRadioOptionChange} checked={this.state.selectRadio === "yes"} value="yes" />
                </div>
                <div className="set-radio-dimension">
                <RadioButton label="No" name="override-radio" onChange={this.handleRadioOptionChange} checked={this.state.selectRadio === "no"} value="no" />  
                </div>
            </div>
            </div>
            </Grid>
            ...
            <div className="version-grid-date-wrapper set-top-margin">
                <div className="form">
                    ...
                    : this.state.selectRadio === "no" ?
                    <input type="text" className="override-popup-no-input" />
                    : ""
                    }   
                    </div>
                <div className="form">
