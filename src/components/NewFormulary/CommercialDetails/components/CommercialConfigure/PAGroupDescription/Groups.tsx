...
import { ReactComponent as StatusIcon } from "../PriorAuthorization/assets/status.svg";
import { ReactComponent as EditIcon } from "../PriorAuthorization/assets/statusedit.svg";
interface Props {
  id: number;
  title: string;
  statusType: string;
