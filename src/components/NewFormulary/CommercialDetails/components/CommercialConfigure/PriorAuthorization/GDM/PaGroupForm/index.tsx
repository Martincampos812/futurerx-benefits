    ...
    <div className='new-group-des'>
      ...
      <div className='version-wrapper'>
        <div className='item-text version-dd'>
          ...
          <AngleDownIcon style={{ fill: "#F65A1C" }} />
        </div>
        <div className='item pointer' onClick={(e) => {}}>
          <VersionHistoryIcon style={{ fill: "#F65A1C" }} />
          Version History
        </div>
        <div
          className='item pointer'
          onClick={(e) => props.popupClick("clone", "CLONE 2021CARE926-1")}
        >
          <CloneIcon style={{ fill: "#F65A1C" }} />
          Clone
        </div>
        <div
          className='item pointer'
          onClick={(e) => props.popupClick("version", "ADD FORMULARY VERSION")}
        >
          <PlusCircleIcon style={{ fill: "#F65A1C" }} />
          New Version
        </div>
        <div
          className='item pointer'
          onClick={(e) => props.popupClick("delete", "DELETE 2021CARE926-1")}
        >
          <CrossCircleIcon style={{ fill: "#F65A1C" }} />
          Delete
        </div>
        <div
          className='item pointer'
          onClick={(e) => props.popupClick("archive", "ARCHIVE 2021CARE926-1")}
        >
          <ArchiveIcon style={{ fill: "#F65A1C" }} />
          Archive
        </div>
      </div>
      ...
      {isAdditionalCriteriaPopupOpen ? (
        <AdditionalCriteriaPopup
          category='Grievances'
          openPopup={isAdditionalCriteriaPopupOpen}
          onClose={additionalCriteriaHandler}
        />
      ) : null}
    </div>
  );
