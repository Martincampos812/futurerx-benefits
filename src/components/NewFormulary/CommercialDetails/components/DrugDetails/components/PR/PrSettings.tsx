  ...
  return (
    <div className="pr-limit-settings bordered mb-10">
      ...
      <div className="inner-container">
        <StatusContentFormPanel title="Patient Residence" type="covered">
            <div className="input-field-group">
              ...
              <div className="input-field-group__radio-field-group">
                  <div className="input-field-group__radio-field">      
                    ...
                    <label htmlFor="N/A" className="checkbox-label">00 - Not Specified</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">01 - Home</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">03 - Nursing Facility/Long Term Care</label>
                  </div>
                
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">04 - Assisted Living Facility</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">06 - Group Home</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">09 - Intermediate Care/Mentally Retarded</label>
                  </div>

                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">11 - Hospice</label>
                  </div>
                </div>
            </div>
        </StatusContentFormPanel>
        
        <div className="pr-limit-settings__add-new-form-action">
          <AddIcon/>
          <span className="pr-limit-settings__add-new-form-action-text">Add PR Criteria</span>
        </div>
      </div>
    </div>
  )
