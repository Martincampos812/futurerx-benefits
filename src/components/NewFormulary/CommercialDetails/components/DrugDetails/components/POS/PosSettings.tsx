...
const PosLimitSettings = () => {
  return (
    <div className="pos-limit-settings bordered mb-10">
      <PanelHeader title="place of service settings" tooltip="place of service settings" />
      ...
      <div className="inner-container">
        <StatusContentFormPanel title="Place of Service" type="covered">
            <div className="input-field-group">
              <div className="input-field-group__header">      
                ...
                <div className="input-field-group__select-all-action">Select all</div>
              </div>
              ...
              <div className="input-field-group__radio-field-group">
                  <div className="input-field-group__radio-field">      
                    ...
                    <label htmlFor="N/A" className="checkbox-label">01 - Community/Retail Pharmacy </label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">02 - Compounding Pharmacy</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">03 - Home Infusion Therapy</label>
                  </div>
                
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">04 - Institutional Pharmacy</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">05 - LTC Pharmacy</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">06 - Mail Order Pharmacy</label>
                  </div>

                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">07 - Managed Care Organization Pharmacy</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">08 - Specialty Care Pharmacy</label>
                  </div>
                  
                  <div className="input-field-group__radio-field">      
                    <input type="checkbox" id="vehicle1" name="N/A" value="N/A" />
                    <label htmlFor="N/A" className="checkbox-label">99 - Other</label>
                  </div>
                </div>
            </div>
        ...
        <div className="pos-limit-settings__add-new-form-action">
          <AddIcon/>
          <span className="pos-limit-settings__add-new-form-action-text">Add POS Criteria</span>
        </div>
      </div>
    </div>
  )
