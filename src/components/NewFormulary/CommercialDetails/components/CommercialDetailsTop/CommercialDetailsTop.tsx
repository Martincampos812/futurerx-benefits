...
import { getCompareFormularyVersionHistoryColumn } from "../../../../../mocks/formulary-grid/FormularyGridColumn";
import { getCompareFormularyViewAllGridData } from "../../../../../mocks/formulary-grid/FormularyGridData";

export default function CommercialDetailsTop(props: any) {
  ...
  React.useEffect(() => {
    setData(getCompareFormularyViewAllGridData());
  }, []);
    ...
    <div className='drug-detail-top'>
      <div className='breadcrum-sec'>
        ...
        <div className='version-wrapper'>
          <div className='version-dd'></div>
          <div onClick={toggleShowViewAll} className='item'>
            <svg
              width='11'
              height='11'
              viewBox='0 0 11 11'
          ...
          {!props.isReadOnly ? (
            <>
              <div className='item'>
                <span
                  onClick={(e) =>
                    props.popupClick("clone", "CLONE 2021CARE926-1")
                  }
                >
                  <svg
                    width='13'
              ...
              <div className='item'>
                <span
                  onClick={(e) =>
                    props.popupClick("version", "ADD FORMULARY VERSION")
                  }
                >
                  <svg
                    width='13'
              ...
              <div className='item'>
                <span
                  onClick={(e) =>
                    props.popupClick("delete", "DELETE 2021CARE926-1")
                  }
                >
                  <svg
                    width='11'
              ...
              <div className='item'>
                <span
                  onClick={(e) =>
                    props.popupClick("archive", "ARCHIVE 2021CARE926-1")
                  }
                >
                  <svg
                    width='11'
      ...
      <div className='durationInfo d-flex'>
        <div className='item'>
          <span className='tag purple'>Commercial</span>
        </div>
