  ...
  return (
    <div className="drug-detail-top">
      ...
      <div className="durationInfo d-flex">
        <div className="item">
          { MassMaintenance.currentSelectedModule === 'medicare' && <span className="tag purple">Medicare</span>} 
          { MassMaintenance.currentSelectedModule === 'commercial' && <span className="tag grey">Commercial</span>} 
        </div>
        <div className="item">
