...
import { getMaintenanceMassUpdateDataCommercial } from "../../../../mocks/MaintenanceMassUpdateMockDataCommercial";
...
class MaintenanceMassUpdate extends Component<Props, State> {
  ...
  componentDidMount() {
    const data = this.getColumnsData(); //getDrugDetailData();
  ...
  getColumnsData = () => {
    switch (this.props.type) {
      case 'commercial':
          return getMaintenanceMassUpdateDataCommercial();
        break;
      case 'medicare':
          return getMaintenanceMassUpdateData();
        break;
