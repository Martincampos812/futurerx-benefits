...
const TreeNodeTitle = ({groupTitle, title}) => {
  return (
    <span className="tree-node-title">
      {
        groupTitle && 
        <span className="tree-node-title__group">
          { groupTitle }
        </span>
      }
...
const treeData = [
  {
    title: <TreeNodeTitle groupTitle="Group" title="Aminoglycosides (07************)"/>,
    value: "0-0",
    key: "0-0",
    lable: "Group",
    children: [
      {
        title: <TreeNodeTitle groupTitle="Class" title="Aminoglycosides (07************)"/>,
        value: "0-0-0",
        key: "0-0-0",
        lable: "Class",
        children: [
          {
            title: <TreeNodeTitle groupTitle="SubClass" title="Aminoglycosides (07************)"/>,
            value: "1-0-0",
            key: "1-0-0",
            lable: "Class",
            children: [
              {
                title: <TreeNodeTitle groupTitle="Base" title="Aminoglycosides (07************)"/>,
                value: "1-1-0",
                key: "1-1-0",
                lable: "Class",
                checkable: false,
  ...
  return (
    <div className="__root-gpi">
      <div className="search-box-container">        
        <SearchBox iconPosition="left" onChange={onSearch} value={searchValue} placeholder="Search by GPI/Generic Name/Label Name/DDID" style={{paddingLeft: '30px'}}/>
        <ClearIcon className="search-box-container__clear-action" onClick={onClearSearch}/>
      </div>
      <div className="search-tag-list">
        <div className="search-tag-list__item">Amikacin <RemoveIcon className="search-tag-list__remove-action"/></div>
      </div>
      
      {
        ...
        <div className="search-tree-list">
          <Tree {...tProps}/>
          <div className="search-tree-list__hide-label-action"><HideIcon/><span className="search-tree-list__hide-label-action-text">Hide labels</span></div>
        </div>
      }
    </div>
  );
